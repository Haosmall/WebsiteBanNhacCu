...
<link rel="stylesheet" href="<c:url value="/static/assets/css/Product_page/ProductPage.css"/>">
</head>
<body>
                ...
                <div class="boxSearch">
                    ...
                    <div class="itemSearch">
						<c:forEach items="${ loaiSanPhams }" var="loaiSanPham">
							<input type="checkbox" value="${ loaiSanPham.id }" onchange="console.log(1233123)" />
                ...
                <div class="boxSearch">
                    ...
                    <div class="itemSearch">
						<c:forEach items="${ thuongHieus }" var="thuongHieu">
							<input type="checkbox" value="${ thuongHieu.id }" onchange="console.log(1233123)" />
                ...
                <div class="boxSearch">
                    ...
                    <div class="itemSearch">
						<c:forEach items="${ dongSanPhams }" var="dongSanPham">
							<input type="checkbox" value="${ dongSanPham.id }" onchange="console.log(1233123)" />
                    ...
                    <div class="product__list">
                    	...
                    	<c:forEach items="${ sanPhamDTOs }" var="sanPhamDTO">
                    		<div class="product">
	                            ...
	                            <p class="product__name"><b>${ sanPhamDTO.tenSanPham }</b></p>
	
	                            <div class="additional">
	                                <p>Thương hiệu: <b>${ sanPhamDTO.tenThuongHieu }</b></p>
	                                <p>Xuất xứ: <b>${ sanPhamDTO.xuatXu }</b></p>
	                            </div>
	
	                            <p class="money"><fmt:formatNumber type = "currency" value = "${ sanPhamDTO.giaBan }" currencySymbol=""/> VNĐ</p>
